package com.github.buoooou.wxpay.util;

import com.github.buoooou.wxpay.bean.request.BaseWxPayRequest;
...
public class SignUtils {
    ...
    public static String createSign(Map<String, String> params, String signType, String signKey, String[] ignoredParams) {
        ...
        if (SignType.HMAC_SHA256.equals(signType)) {
            return com.github.buoooou.wxpay.common.util.SignUtils.createHmacSha256Sign(toSign.toString(), signKey);
        } else {
