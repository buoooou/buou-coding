...
public interface WxPayService {
     ...
     * 调用统一下单接口，并组装生成支付所需参数对象.
     *
     * @param <T>       请使用{@link com.github.buoooou.wxpay.bean.result.WxPayUnifiedOrderV3Result}里的内部类或字段
     * @param tradeType the trade type
     * @param request   统一下单请求参数
     * @return 返回 {@link com.github.buoooou.wxpay.bean.result.WxPayUnifiedOrderV3Result}里的内部类或字段
     * @throws WxPayException the wx pay exception
     */
