package com.github.buoooou.core.util.id;

import com.github.buoooou.core.async.AsyncUtil;
import com.github.buoooou.core.util.CompressUtil;
import com.github.buoooou.core.util.id.snowflake.PaiSnowflakeIdGenerator;
import com.github.buoooou.core.util.id.snowflake.SnowflakeProducer;

import static com.github.buoooou.core.util.CompressUtil.int2str;
