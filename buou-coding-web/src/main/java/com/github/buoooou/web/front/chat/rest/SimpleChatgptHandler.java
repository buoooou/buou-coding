package com.github.buoooou.web.front.chat.rest;

import cn.hutool.core.date.LocalDateTimeUtil;
import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.github.buoooou.api.model.context.ReqInfoContext;
import com.github.buoooou.api.model.enums.ChatSocketStateEnum;
...
public class SimpleChatgptHandler extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        session.sendMessage(getTextMessage("开始你和布欧的AI之旅吧", ChatSocketStateEnum.Established.getCode()));
    }
