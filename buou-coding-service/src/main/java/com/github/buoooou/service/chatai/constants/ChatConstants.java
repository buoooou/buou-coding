package com.github.buoooou.service.chatai.constants;
...
public final class ChatConstants {
    ...
    public static final String CHAT_REPLY_RECOMMEND = "请注册布欧社区之后再来体验吧，官网： \n https://buoucoding.com";
     ...
     * 异步聊天时返回得提示文案
     */
    public static final String ASYNC_CHAT_TIP = "布欧正在努力回答中, 耐心等待一下吧...";


    public static final String SENSITIVE_QUESTION = "提问中包含敏感词:%s，请微信联系「kafeihu92」加入白名单!";
}
