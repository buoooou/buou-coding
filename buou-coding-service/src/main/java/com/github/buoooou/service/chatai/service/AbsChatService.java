package com.github.buoooou.service.chatai.service;
...
import com.github.buoooou.service.chatai.constants.ChatConstants;
...
public abstract class AbsChatService implements ChatService {
    ...
    public ChatRecordsVo getChatHistory(Long user, AISourceEnum aiSource) {
        ...
        chats.add(0, new ChatItemVo().initAnswer(String.format("开始你和布欧(%s-大模型)的AI之旅吧!", aiSource.getName())));
